    ...
    <div className="min-h-dvh flex items-center justify-center page-gradient px-4 py-6 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-7 bg-white/92 backdrop-blur-xl rounded-3xl shadow-2xl shadow-primary/10 p-6 min-[380px]:p-8 sm:p-10 border border-white/80">
        <div className="text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-textMain tracking-tight mb-2">Join KickNest</h2>
          <p className="text-textSecondary text-base sm:text-lg font-medium">Create your account to get started</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="mt-6 space-y-5">
          <div className="space-y-4">
            ...
            <div className="group relative">
              <label className="block text-sm font-bold text-textMain mb-1.5 ml-1 transition-colors group-focus-within:text-primary">Create Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-textSecondary group-focus-within:text-primary transition-colors">
            ...
            <div className="group relative">
              <label className="block text-sm font-bold text-textMain mb-1.5 ml-1 transition-colors group-focus-within:text-primary">Confirm Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-textSecondary group-focus-within:text-primary transition-colors">
                  <HiLockClosed className="h-5 w-5" />
                </div>
          ...
          >
            {loading ? (
              ...
              <span className="flex items-center">
                Start Journey <HiUserAdd className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </span>
            )}
          </button>
        </form>
